...
const Home = () => {
  const [worthLivingImgActive, setWorthLivingImgActive] =
    useState(couplePyramids);
      ...
      <div className="bootstrap-wrapper">
          ...
          <div className={`container ${classes.container}`}>
            <div className="row">
              <div className={`column col-12 col-lg-6 ${classes.column}`}>
                ...
                <div className="row">
                  <div
                    className="col-2 hidden-md-down"
                    style={{ lineHeight: "0rem", marginTop: ".25rem" }}
                  >
                    ________
                  </div>
                  <div className="col-lg-8" style={{ position: "relative" }}>
                    <p style={{ marginTop: "0", fontSize: "1.2rem" }}>
                      Are you ready for retirement? Find out by scheduling a
                      free consultation.
                    </p>
                    <p>
                      You'll speak with one of our registered and licensed
                      retirement fiduciaries at no charge. Get started today!
                    </p>
                    <button
                      className="redWhtRedBtn"
                      onClick={() => {
                        return gtag_report_conversion(
                          "https://form.jotform.com/251396202052044"
                        );
                      }}
                    >
                      SEE IF YOU'RE READY
        ...
        >
          <div className={`container ${classes.container}`}>
            <div className="row">
              ...
              >
                <p style={{ margin: "0" }}>
                  A Well Managed Plan Makes a Dream Reality!
                </p>
                <h1
                  className={classes.large}
                  style={{ marginTop: "15px", marginBottom: "15px" }}
                >
                  Let Us Help You Live a Fulfilled Retirement!
                </h1>
                <div style={{ position: "relative" }}>
                  <p style={{ margin: "0" }}>
                    You've spent the past 35+ years working, it's time to enjoy
                    the fruits of your labor. Let us handle the burden of your
                    finances, so that you can begin the life you worked so hard
                    for.
                  </p>
                </div>
                <div
                  className={`row ${classes["worthLivingImages"]}`}
                  style={{ display: "flex" }}
                >
                  <div
                    className="col-4"
                    onClick={updateWorthLivingImgHandler}
                    data-url={couplePyramids}
                  >
              ...
              <div className={`column col-12 col-lg-6 ${classes.column}`}>
                ...
                <div className="row">
                  ...
                  >
                    <p>
                      “I wanted to know where I was, if I had enough. These guys
                      are the experts. They put together a detailed plan, and
                      explained it to me in words I understood.
                    </p>
                    <p>
                      I pulled the trigger on retirement in 2014, not a day goes
                      by that I don’t miss work, but I have found plenty of
                      things to keep me busy.
                    </p>
                    <p>
                      Nowadays, I worry more about what I am going to do
                      tomorrow than I do my finances...I trust these guys..and I
                      never quite like finances anyhow.”
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className={`column col-12 col-lg-6 ${classes.column}`}>
                <h1 className={classes.large}>
                  Registered Fiduciaries Put Your Interest First
                </h1>
                <p style={{ marginTop: "0", color: "white", fontSize: "1rem" }}>
                  Sunpath's Fiduciaries Represent the Gold Standard
                </p>
                <p>
                  As a registered investment advisory firm, Sunpath Financial's
                  fiduciary advisors represent the highest ethical standards, so
              ...
              >
                <img src={workingWithClients} style={{ width: "100%" }} />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              ...
              >
                <div className={classes.textRight}>
                  ...
                  <h1 className={classes.large}>
                    We Help Our Clients Build and Maintain Their Finances
                  </h1>
                  <div style={{ position: "relative" }}>
                    <p>
                      Building and maintaing a retirement plan is challenging,
                      but if you equip yourself with the right team of advisors,
                      you can turn a burden into your dream retirement.
                    </p>
                    ...
                    <p>
                      Sunpath's fiduciaries are ready to help you tackle your
                      retirement challenges, so that you can spend time enjoying
              ...
              >
                <div className={`${classes.ourServicesFeatures}`}>
                  ...
                  <p>
                    Applying for your social security and pension benefit is
                    complex and irreversible. Our professionals can help you
                    maximize your benefit and complete your application.
                  </p>
                </div>
                <div className={`${classes.ourServicesFeatures}`}>
                  ...
                  {/* <img  style={{width: '100%'}}></img> */}
                  <p>
                    With sophisticated software and years of experience, we're
                    able to work with clients and our/their CPAs to dramtically
                    decrease their lifetime tax liability.
                  </p>
                </div>
                <div className={`${classes.ourServicesFeatures}`}>
                  ...
                  {/* <img  style={{width: "100%"}}></img> */}
                  <p>
                    We assist our clients with tax-free rollovers, income
                    distributions, and build well diversified, customized
                    portfolios to balance their risk reward.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`container ${classes.container}`}>
            <div className="row">
              <div className={`column col-12 col-lg-5 ${classes.column}`}>
                ...
                <div style={{ position: "relative" }}>
                  <p>
                    We work hard to help our clients meet their financial goals,
                    we strive to protect the financial freedom they worked so
                    hard for.
                  </p>
                  <p>
                  ...
                  <p>
                    We would love to hear your story, your challenges, to see if
                    we can help you like we've done so many.
                  </p>
                  <div className="row" style={{ padding: "0" }}>
                    <div className="col-8">
                      <button
              ...
              <div
                className={`column col-12 col-lg-7 ${classes.column}`}
                style={{ margin: "auto" }}
              >
                <a
                  href="https://www.youtube.com/watch?v=nfeWhmYUUY0"
                  target="_blank"
                >
        ...
        <div className={classes.wrapWht + " " + classes.eventSection}>
          <div className={`container ${classes.container}`}>
            <div className="row">
              <div
                className={`column col-12 col-lg-6 order-lg-2 ${classes.column}`}
              >
                <p style={{ margin: "0" }}>
                  Successful Retirees Seek an Education!
                </p>
                <h1
                  className={classes.large}
                  style={{ marginTop: "15px", marginBottom: "15px" }}
                >
                  Join Our Live Educational Dinner Events
                </h1>
                <div style={{ position: "relative" }}>
                  <p style={{ margin: "0" }}>
                    Our educational dinner events were designed to help retirees
                    understand the fundamentals of retirement. From social
                    security and pensions, to tax planning, medicare and estate
                    planning, Sunpath covers all the major topics of retirement.
                  </p>
                </div>
                <div
                  className={`row ${classes["eventImages"]}`}
                  style={{ display: "flex" }}
                >
                  <div
                    className="col-4"
                    onClick={updateEventsImgHandler}
                    data-url={flemmingsRanchoJoshCloseUp}
                  >
                    <img
                      src={flemmingsRanchoJoshCloseUp}
                      data-url={flemmingsRanchoJoshCloseUp}
                    />
                  </div>
                  <div
                  ...
                  <div
                    className="col-4"
                    onClick={updateEventsImgHandler}
                    data-url={flemmingsRanchoJoshBackRoom}
                  >
                    <img
                      src={flemmingsRanchoJoshBackRoom}
                      data-url={flemmingsRanchoJoshBackRoom}
                    />
                  </div>
                  <div
                    className="col-4"
                    onClick={updateEventsImgHandler}
                    data-url={officeNewportKitchen}
                  >
                    <img
                      src={officeNewportKitchen}
                      data-url={officeNewportKitchen}
                    />
                  </div>
                  <div
                    className="col-4"
                    onClick={updateEventsImgHandler}
                    data-url={officeNewportDisplay}
                  >
                    <img
                      src={officeNewportDisplay}
                      data-url={officeNewportDisplay}
                    />
                  </div>
                  <div
                ...
                >
                  <div className="col-8">
                    <button
                      className="whtBlkWhtBtn"
                      onClick={() => {
                        alert(
                          "At this time we do not have any events scheduled. Please try back at a later date."
                        );
                      }}
                    >
                      REGISTER FOR EVENT
        ...
        <div className={classes.wrapNavy + " " + classes.location}>
          <div className={`container ${classes.container}`}>
            <div className="row">
              <div className={`column col-12 col-lg-6 ${classes.column}`}>
                <h1 className={classes.large}>
                  Located in Beautiful Newport Beach
                </h1>
                <p>
                  Neslted against Newport Backbay, across the street from
                  Fletcher Jones Mercedes Benz, off SR-73 and Jamboree,
                  Sunpath's headquarter is a central lcoation and makes serving
                  Southern California a breeze.
                </p>
                <p
                  style={{ borderLeft: "1px solid white", paddingLeft: "1rem" }}
                >
                  <span style={{ fontWeight: "bold" }}>
                    Sunpath Financial, Inc.
                  </span>
                  <span className="paragraphBreak">
